    ...
    public List<Student> getAllStudents() {
        ...
        try (Connection connection = Database.getConnection();
            ...
            while (resultSet.next()) {
                ...
                System.out.println("first_name from db: " + firstName);
...
//            UpdateStudent.setIndexNumber(index_number);
    ...
    public boolean deleteStudent(String indexNumber) throws SQLException {
        String sql = "DELETE FROM student WHERE index_number = ?";
        try (Connection connection = Database.getConnection();
             PreparedStatement statement = connection.prepareStatement(sql)) {
            statement.setString(1, indexNumber);
